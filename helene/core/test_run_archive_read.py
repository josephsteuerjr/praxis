...
import run_manager as _run_manager

# ⚠ Отличие издания (ревью W2 S1, 26.09): чтение тел из холодного архива держит POSIX
# openat/no-follow. На Windows издание архива не ведёт (старые результаты снимает
# ретенция), и такое чтение честно отказывает — эти проверки идут в Linux-гейте.
_POSIX_ARCHIVE = unittest.skipUnless(
    _run_manager._SAFE_ARCHIVE_OPENAT_SUPPORTED,
    "холодный архив улик — только POSIX openat (в издании на Windows архива нет)")
