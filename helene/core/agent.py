...
COMPUTER_TOOL = {
    ...
    "description": (
        ...
        "typed type_text/hotkey/key/move/click/scroll actions; input accepts one ordered mixed events batch. After a "
        "click into a text field do not assume the caret is free: many controls (WinForms TextBox) select all text on "
        "focus and type_text would REPLACE it — press End/Escape or click a second time before typing. For scroll, "
