...
class NightPassTests(Pass20Base):
    ...
    def test_light_skips(self):
        ...
        self.assertIn("ревизия характера пропущена", identity.night_pass("light"))  # 26.09: без рода
    ...
    def test_model_unavailable_keeps_material(self):
        ...
        self.assertIn("ревизия отложена", identity.night_pass("full"))  # 26.09: без рода
