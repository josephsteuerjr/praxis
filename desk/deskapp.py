...
_OPEN_PATHS = {"/m", "/m/", "/m/manifest.webmanifest", "/pair/redeem",
               ...
               # config.js читает САМА СТРАНИЦА первым тегом — до того, как у
               # неё появился ключ. Имён агента и продукта там ровно столько
               # же, сколько в манифесте PWA, который открыт по той же причине.
               "/config.js", "/m/config.js"}
