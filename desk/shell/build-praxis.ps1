# Сборка оболочки в варианте «Praxis» (окно к своему серверу).
#
...
$env:TAURI_CONFIG = '{"productName":"Praxis","identifier":"app.praxis.desk","bundle":{"icon":["icons-praxis/icon.ico","icons-praxis/icon.png"]}}'
...
Write-Host "готово: $PSScriptRoot\target-praxis\release\helene.exe (productName=Praxis, app.praxis.desk)"
