...
function stubNotice(): string {
  ...
  return `<div class="notice">
    <span class="dot"></span>
    <span>Этот чат — заглушка: программа агента ещё не умеет несколько чатов с агентом (появится в 0.3.3). Здесь можно проверить, как это будет выглядеть; писать — в основной чат.</span>
  </div>`;
}
