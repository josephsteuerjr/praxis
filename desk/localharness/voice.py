...
Живые числа (машина владельца, 10.09.2026, `small`, int8, 4 потока): загрузка
модели с диска 3,8 с, расшифровка 3,9 с на 9,2 с речи.
"""
...
CATALOG: dict[str, dict] = {
    "small": {
        ...
        "size_mb": 480,
        "note": "Понимает речь, но путается в именах и редких словах. "
                "Расшифровка примерно вдвое быстрее длительности записи.",
    },
    "turbo": {
        "repo": "mobiuslabsgmbh/faster-whisper-large-v3-turbo",
        "title": "large-v3-turbo — как на сервере",
        "size_mb": 1600,
        "note": "Та же модель, что у агента на сервере: заметно точнее на именах "
                "и терминах, но и памяти с процессором просит больше.",
    },
}
DEFAULT_MODEL = "turbo"
