...
#   sh install.sh [--from Helene-0.7.2-macos-arm64.zip] [--relaunch]
...
HELENE_TAG_DEFAULT="v0.7.2"   # вписывает сборка (build_mac.stamp_install_sh); HELENE_TAG в среде — сильнее
