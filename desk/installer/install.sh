...
#   sh install.sh [--from Helene-1.0.3-macos-arm64.zip] [--relaunch]
...
HELENE_TAG_DEFAULT="v1.0.3"   # вписывает сборка (build_mac.stamp_install_sh); HELENE_TAG в среде — сильнее
