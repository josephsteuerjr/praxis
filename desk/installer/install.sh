...
#   sh install.sh [--from Helene-0.8.2-macos-arm64.zip] [--relaunch]
...
HELENE_TAG_DEFAULT="v0.8.2"   # вписывает сборка (build_mac.stamp_install_sh); HELENE_TAG в среде — сильнее
...
Ставится в $HOME_DIR. Другой выпуск: HELENE_TAG=v0.8.2 sh install.sh
