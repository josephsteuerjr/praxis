...
Praxis — свободное ПО: её можно изучать, менять и распространять на условиях GNU Affero
General Public License версии 3 или любой более поздней. Ключевое отличие AGPL от GPL —
**сетевое использование**: если вы измените Praxis и дадите людям работать с изменённой
версией по сети, вы обязаны предоставить этим людям исходный код изменённой версии
(раздел 13 AGPLv3).

Почему именно AGPL и что об этом думают авторы — в [NOTICE](NOTICE).
