...
// Z.ai low/high/max, полем `output_config.effort` — `reasoning_effort` этот
// эндпойнт Z.ai молча глотал, проба 08.09), остальным — ничего, глубину решает модель. Параметр
